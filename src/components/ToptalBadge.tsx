...
function ToptalWordmark() {
  return (
    <svg viewBox="0 0 108 30" width={100} xmlns="http://www.w3.org/2000/svg" aria-hidden>
...
type ToptalBadgeProps = {
  className?: string
}

export function ToptalBadge({ className = '' }: ToptalBadgeProps) {
  return (
    <motion.a
      href={profile.toptal}
      target="_blank"
      ...
      aria-label="Top 3% Toptal talent — view profile and hire on Toptal"
    >
      <div
        className="inline-block p-1.5 transition-transform duration-300 group-hover:scale-[1.03]"
        style={{ clipPath: hex, background: '#25a9ef' }}
      >
        <div
          className="w-[200px] flex flex-col items-center gap-2 pt-6 pb-10 text-white text-center"
          style={{
            clipPath: hex,
        ...
        >
          <ToptalStars />
          <h3 className="m-0 text-[19px] font-bold leading-none tracking-tight">TOP 3% TALENT</h3>
          <div className="w-[120px] h-px bg-[#25a9ef]" />
          <span className="text-base opacity-80 -mb-1.5">Vetted by</span>
          <ToptalWordmark />
          <span
            className="inline-flex items-center justify-center px-5 py-1 rounded-md bg-[#296bff] text-white text-base font-medium mt-1 group-hover:bg-[#3d7aff] transition-colors"
          >
            Hire me
          </span>
        </div>
